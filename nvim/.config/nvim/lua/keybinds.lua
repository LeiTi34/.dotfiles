...
map('n', '<Leader>bt', ':BufferLineCycleNext<CR>', { noremap = true, silent = true })
map('n', '<Leader>bT', ':BufferLineCyclePrev<CR>', { noremap = true, silent = true })
-- These commands will move the current buffer backwards or forwards in the bufferline
map('n', '<Leader>bmt', ':BufferLineMoveNext<CR>', { noremap = true, silent = true })
map('n', '<Leader>bmT', ':BufferLineMovePrev<CR>', { noremap = true, silent = true })
